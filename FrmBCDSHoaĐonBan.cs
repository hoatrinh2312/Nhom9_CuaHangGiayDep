...
{
    public partial class FrmBCDSHoaĐonBan : Form
    {
        DataTable tblBCDSHDB;
        double tong;
        public FrmBCDSHoaĐonBan()
        {
            InitializeComponent();
        }

        private void FrmBCDSHoaĐonBan_Load(object sender, EventArgs e)
        {
        ...
        private void DataGridView_BCDSHDB_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (MessageBox.Show("bạn có muốn hiển thị thông tin chi tiết?", "xác nhận",
MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                cboMaNV.Text = DataGridView_BCDSHDB.CurrentRow.Cells["MaNV"].Value.ToString();
                txtSoHDB.Text = DataGridView_BCDSHDB.CurrentRow.Cells["SoHDB"].Value.ToString();
                txtTongTien.Text = DataGridView_BCDSHDB.CurrentRow.Cells["TongTien"].Value.ToString();
                txtTenNV.Text = DataGridView_BCDSHDB.CurrentRow.Cells["TenNV"].Value.ToString();
                txtMaKhach.Text = DataGridView_BCDSHDB.CurrentRow.Cells["MaKhach"].Value.ToString();
                txtNgayBan.Text = DataGridView_BCDSHDB.CurrentRow.Cells["NgayBan"].Value.ToString();
            }
