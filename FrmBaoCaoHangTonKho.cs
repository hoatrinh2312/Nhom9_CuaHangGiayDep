...
namespace CuaHangGiayDep
{
    public partial class FrmBaoCaoHangTonKho : Form
    {
        ...
        {
            txtMaGD.Text = dataGridView_BaoCao.CurrentRow.Cells["MaGD"].Value.ToString();
            txtTenGD.Text = dataGridView_BaoCao.CurrentRow.Cells["TenGD"].Value.ToString();
        ...
        private void btnInBaoCao_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C6:O6"].ColumnWidth = 14;
