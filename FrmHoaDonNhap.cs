    ...
    public partial class FrmHoaDonNhap : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO ChiTietHDN(SoHDN,MaGD,SoLuong,DonGia, GiamGia,ThanhTien) VALUES(N'" + txtSoHDN.Text.Trim() + "',N'" + cboMaGD.SelectedValue + "'," + txtSoLuong.Text + "," + txtDonGia.Text + "," + txtGiamGia.Text + "," + txtThanhTien.Text + ")";
                Functions.RunSQL(sql);
                LoadDataGridView();
